...
void MX_GTZC_S_Init(void)
{
  ...
  if (HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_CORDIC, GTZC_TZSC_PERIPH_SEC|GTZC_TZSC_PERIPH_NPRIV) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_FMAC, GTZC_TZSC_PERIPH_SEC|GTZC_TZSC_PERIPH_NPRIV) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  if (HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_DCMI_PSSI, GTZC_TZSC_PERIPH_SEC|GTZC_TZSC_PERIPH_NPRIV) != HAL_OK)
  {
    Error_Handler();
  }
